...
<head>
  ...
  <title>Ariella's Portfolio</title>
  <link rel="shortcut icon" href="img/team/Ariella.png" />
        ...
        <div>
          <div class="form-area">
            <form role="form"  method="post" action="index.php" onSubmit="openCanvas">
              ...
              <div class="form-group">
                <textarea class="form-control" type="textarea" id="message" placeholder="Message" maxlength="200"
                  rows="7"></textarea>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#contact" onClick="openCanvas()">Contact</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <header class="masthead">
    <div class="container">
      <div class="intro-text">
        ...
        <a class="btn btn-xl js-scroll-trigger" href="#me">Tell Me More</a>
      </div>
    </div>
  </header>
    ...
    <div class="container">
      ...
      <div class="row text-center">
        <div class="col-md-4">
          ...
          <h4 class="service-heading">Customer Experience Expert</h4>
        ...
        <div class="col-md-4">
          ...
          <h4 class="service-heading">Frontend Developer</h4>
          <p class="text-muted">HTML, CSS, JavaScript, ES6, VUE.js, MongoDB, Node.js, GIT, SCSS, Responsive UI, jQuery,
            Bootstrap, Ajax, Socket.io, Angular, PHP and more.
          </p>
        </div>
        <div class="col-md-4">
          <span class="fa-stack fa-4x">
    ...
    <div class="row">
      <div class="col-sm-4">
        <div class="team-member">
          <img class="mx-auto rounded-circle" src="img/team/Ariella.png" alt="">
          <h4>Ariella Wills</h4>
      ...
      <div class="col-sm-8 flex-align-center">
        <p class="large text-muted  about-description">I’m a frontend developer with a strong interest in technology.
          I’m self-motivated, responsible and organized.
          I bring with me a diverse background, having filled numerous functions in product companies, including QA,
        ...
        <div class="col-md-4 flex-align-center">
          <ul class="list-inline social-buttons flex-align-center">
            ...
            <li class="list-inline-item flex-align-center">
              <a href="https://www.facebook.com/ariella.wills" target="_blank">
                <i class="fa fa-facebook"></i>
              </a>
            </li>
            <li class="list-inline-item">
              <a href="https://www.linkedin.com/in/ariella-wills-36189a12/" target="_blank">
  ...
  <div class="portfolio-modal modal fade" id="portfolioModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="container">
          <div class="row" id="modals-container">
