...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function () {
      ...
      _createClass(PalindromEditorComponent, [{
        ...
        value: function onAddCharRight($event) {
          var rightIdx = $event.letterIndex;
          var leftIdx = this.lettersRight.length - 1 - rightIdx;
        ...
        value: function onAddCharLeft($event) {
          var character = $event.character;
          var leftIdx = $event.letterIndex;
          var rightIdx = this.lettersLeft.length - 1 - leftIdx;
        ...
        value: function onCharacterChangedRight($event) {
          this.replaceLetter(this.lettersLeft, this.lettersRight, $event.letterIndex, $event.prevChar, $event.newChar, _common_services_services__WEBPACK_IMPORTED_MODULE_2__["PalindromSection"].Right);
        }
      }, {
        key: "onCharacterChangedLeft",
        value: function onCharacterChangedLeft($event) {
          this.replaceLetter(this.lettersRight, this.lettersLeft, $event.letterIndex, $event.prevChar, $event.newChar, _common_services_services__WEBPACK_IMPORTED_MODULE_2__["PalindromSection"].Left);
        }
      }, {
        ...
        value: function moveFocusRight(side, letterIdx) {
          if (side === _common_services_services__WEBPACK_IMPORTED_MODULE_2__["PalindromSection"].Right && letterIdx === this.lettersRight.length - 1) {
        ...
        value: function getIdxFromLetterOnOtherSide(deletedLetter, arr1, arr2, idx2) {
        ...
        value: function focusOnNextPreviousElement(side, id, waitForIt, backOrForward) {
        ...
        key: "addNewChar",
        value: function addNewChar(arr1, idx1, arr2, idx2, newChar) {
        ...
        key: "replaceLetter",
        value: function replaceLetter(arr1, arr2, idx2, oldChar, newChar, side) {
        ...
        value: function countLetterUntilIndex(idx, letter, lettersArr) {
          var letterIdx = 0;
  ...
  function srcAppPivotLetterPivotLetterComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".pivot-box {\n  border-radius: 1rem;\n  border: 3px solid #a57fe8;\n  margin-right: 2px;\n  margin-left: 2px;\n  background-color: #e4cb7d;\n}\n.pivot-box:focus {\n  border: 3px solid #FFDCE0;\n  outline: none;\n  text-shadow: 0 0 0 red;\n}\n.expanded {\n  cursor: text;\n}\n.collapsed {\n  width: 0px;\n  height: 60px;\n  padding: 0px;\n  border-color: black;\n  cursor: pointer;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
