(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LetterBoxComponent = /** @class */ (function () {
                function LetterBoxComponent() {
                    this.character = "";
                    this.side = "";
                ...
                LetterBoxComponent.prototype.ngOnInit = function () {
                    this.assignCharacterType();
                };
                LetterBoxComponent.prototype.isLetterVerification1 = function (character) {
                    return (character.match(this.latinLettersRegex) ||
                        character.match(this.hebrewLettersRegex));
                };
                LetterBoxComponent.prototype.test = function () {
                    console.log("test touch");
                };
                LetterBoxComponent.prototype.handleKeyup = function (event) {
                ...
                LetterBoxComponent.prototype.assignCharacterType = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var PalindromEditorComponent = /** @class */ (function () {
                function PalindromEditorComponent() {
                ...
                // באב. ליל באב.
                PalindromEditorComponent.prototype.ngOnInit = function () {
                    this.pivotElement = document.getElementById("pivot-input");
                    this.pivotElement.focus();
                };
                PalindromEditorComponent.prototype.onAddCharRight = function ($event) {
                ...
                PalindromEditorComponent.prototype.onAddCharLeft = function ($event) {
                ...
                PalindromEditorComponent.prototype.onNewCharFromPivot = function ($event) {
                    this.addNewChar(this.lettersLeft, this.lettersLeft.length, this.lettersRight, 0, $event.newLetter);
                };
                PalindromEditorComponent.prototype.onChangeCharRight = function () { };
                PalindromEditorComponent.prototype.onChangeCharLeft = function () { };
                PalindromEditorComponent.prototype.onDeleteRight = function () { };
                PalindromEditorComponent.prototype.onDeleteLeft = function () { };
                PalindromEditorComponent.prototype.moveFocus = function ($event) {
                ...
                /*HELPERFUNCTIONS */
                PalindromEditorComponent.prototype.moveFocusRight = function (side, letterIdx) {
                    if (side === "right" &&
                ...
                PalindromEditorComponent.prototype.moveFocusLeft = function (side, letterIdx) {
                    if (side === "left" &&
                ...
                PalindromEditorComponent.prototype.onBackspaceLeft = function ($event) {
                ...
                PalindromEditorComponent.prototype.onBackspaceRight = function ($event) {
                ...
                PalindromEditorComponent.prototype.getIdxFromLetterOnOtherSide = function (deletedLetter, arr1, arr2, idx2) {
                ...
                PalindromEditorComponent.prototype.getNodeIfLetterBox = function (currElement) {
                ...
                PalindromEditorComponent.prototype.focusOnNextPreviousElement = function (side, id, waitForIt, backOrForward, arrLength) {
                    if (arrLength === void 0) { arrLength = null; }
                ...
                PalindromEditorComponent.prototype.calculateWheretoDeleteFromOtherSide = function () { };
                PalindromEditorComponent.prototype.isLetterVerification = function (character) {
                    return (character.match(this.latinLettersRegex) ||
                        character.match(this.hebrewLettersRegex));
                };
                PalindromEditorComponent.prototype.addNewChar = function (arr1, idx1, arr2, idx2, newChar) {
                ...
                PalindromEditorComponent.prototype.deleteChar = function (arr1, arr2, idx2, newChar) {
                    var isLetter = this.isLetterVerification(newChar);
                    if (isLetter) {
                ...
                // }
                PalindromEditorComponent.prototype.getLetterFrequency = function (idx, letter, lettersArr) {
                    var letterIdx = 0;
                    for (var i = 0; i <= idx; i++) {
                ...
                PalindromEditorComponent.prototype.findIndexOnOppositeSide = function (lettersArr, letter, letterIdx) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var PivotLetterComponent = /** @class */ (function () {
                function PivotLetterComponent() {
                    this.input = "o";
                ...
                PivotLetterComponent.prototype.ngOnInit = function () { };
                PivotLetterComponent.prototype.expand = function () {
                    this.pivotIsCollapsed = false;
                };
                PivotLetterComponent.prototype.onUserInput = function (event) {
